...
function bossFx(r: ReturnType<typeof rng>, kind: 'fire' | 'gold' | 'dark' | 'rot' | 'soul'): Layer[] {
  ...
  const L: Layer[] = [];
  for (let i = 0; i < 5; i++) L.push({ kind: 'glow', cx: cx + r.range(-90, 90), cy: r.range(PH * 0.15, PH * 0.9), r: r.range(6, 14), color, z: 9 });
  return L;
}
...
export const SUBJECTS: Subject[] = [
  // ---- Region 1: Approach ----
  E('hollowPilgrim', (r) => humanoid(r, { head: 'skull', hunched: true, weapon: { kind: 'sword', raised: false }, cloak: 0.3, height: 0.95, bulk: 0.85, eyes: 'ember' })),
  ...
  E('deserterCrossbow', (r) => humanoid(r, { head: 'hood', weapon: { kind: 'crossbow' }, height: 0.95, bulk: 0.85, cloak: 0.2 })),
  E('pyreHound', (r) => beast(r, { size: 0.95, spines: true, tail: 'long', eyes: 'ember', maw: true }), 'ember'),
  E('charredAcolyte', (r) => robed(r, { eyes: 'ember', staff: false, fx: [{ kind: 'glow', cx: PW * 0.68, cy: PH * 0.55, r: 26, color: 'ember', z: 9 }] }), 'ember'),
  ...
  E('mireHollow', (r) => humanoid(r, { head: 'bare', hunched: true, weapon: { kind: 'club' }, height: 0.95, bulk: 0.9, eyes: 'soul' }), 'verdigris'),
  ...
  E('drownedChorister', (r) => wraith(r, { eyes: 'soul', arms: true, tatter: 0.4 }), 'soul'),
  ...
  // ---- Region 3: Archive ----
  E('archiveScribe', (r) => robed(r, { eyes: 'soul', staff: true, hoodUp: false }), 'soul'),
  ...
  E('silencedScholar', (r) => robed(r, { eyes: 'none', staff: false, fx: [{ kind: 'glow', cx: PW * 0.7, cy: PH * 0.45, r: 30, color: 'soul', z: 9 }] }), 'soul'),
  // ---- Region 4: Sanctum ----
  E('vigilAcolyte', (r) => robed(r, { eyes: 'gold', staff: false, lantern: true }), 'gold'),
  ...
  E('deaconOfStorms', (r) => robed(r, { eyes: 'gold', staff: true, hoodUp: true, fx: [{ kind: 'glow', cx: PW * 0.3, cy: PH * 0.2, r: 22, color: 'gold', z: 9 }] }), 'gold'),
  ...
  E('deepHollow', (r) => humanoid(r, { head: 'bare', weapon: { kind: 'dagger' }, height: 1.0, bulk: 0.9, hunched: true, eyes: 'soul' })),
  E('shadowOfTheLost', (r) => wraith(r, { eyes: 'none', tatter: 1.0, height: 1.1, arms: true }), 'soul'),
  ...
  E('ashWraith', (r) => wraith(r, { eyes: 'ember', tatter: 1.2, height: 1.15 }), 'ember'),
  E('flameShepherd', (r) => robed(r, { eyes: 'ember', staff: true, hoodUp: true, fx: [{ kind: 'glow', cx: PW * 0.7, cy: PH * 0.1, r: 30, color: 'ember', z: 9 }] }), 'ember'),
  ...
  B('choirMaster', (r) => [...robed(r, { eyes: 'soul', staff: false, hoodUp: true, height: 1.2, fx: [] }), { kind: 'mass', pts: taper([PW * 0.7, PH * 0.55], [PW * 0.92, PH * 0.1], 8, 3, r, 0.5, 4), z: 5 }, { kind: 'mass', pts: jitter([[PW * 0.85, PH * 0.05], [PW * 0.99, PH * 0.05], [PW * 0.97, PH * 0.16], [PW * 0.87, PH * 0.16]], r, 1), z: 5, tone: 0.3 }, ...bossFx(r, 'soul')], 'soul'),
  B('archivistNull', (r) => [...robed(r, { eyes: 'soul', staff: true, hoodUp: false, height: 1.25 }), ...bossFx(r, 'soul'), { kind: 'mass', pts: blob(PW * 0.2, PH * 0.4, 40, 30, r, 0.05, 10), z: 1, tone: 0.5 }], 'soul'),
  B('theUnwritten', (r) => [...wraith(r, { eyes: 'none', tatter: 1.4, height: 1.2, arms: true }), ...bossFx(r, 'soul')], 'soul'),
  ...
  B('deaconUnburied', (r) => [...robed(r, { eyes: 'gold', staff: true, hoodUp: true, height: 1.2, fx: [{ kind: 'glow', cx: PW * 0.5, cy: PH * 0.08, r: 40, color: 'gold', z: 9 }] }), ...bossFx(r, 'gold')], 'gold'),
  ...
  B('firstEmber', (r) => [...wraith(r, { eyes: 'none', tatter: 0.6, height: 1.3, sun: true, crown: true }), ...bossFx(r, 'fire')], 'ember'),
  ...
  B('drownedSun', (r) => [...wraith(r, { eyes: 'none', tatter: 0.5, height: 1.25, sun: true }), ...bossFx(r, 'gold')], 'gold'),
  B('abyssWatcher', (r) => [...wraith(r, { eyes: 'soul', tatter: 1.3, height: 1.35, arms: true, crown: true }), ...bossFx(r, 'dark')], 'soul'),
  // ---- Phantoms ----
  ...
  P('ilse', (r) => robed(r, { eyes: 'gold', staff: false, hoodUp: true, lantern: false, fx: [{ kind: 'glow', cx: PW * 0.3, cy: PH * 0.55, r: 22, color: 'gold', z: 9 }] }), 'gold'),
  ...
  P('vesna', (r) => robed(r, { eyes: 'soul', staff: true, hoodUp: false }), 'soul'),
