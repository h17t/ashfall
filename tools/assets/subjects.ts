...
export const SUBJECTS: Subject[] = [
  ...
  E('deepHollow', (r) => humanoid(r, { head: 'skull', weapon: { kind: 'dagger' }, height: 1.0, bulk: 1.0, hunched: true, lunge: true, cloak: 0.25, eyes: 'soul', chains: true })),
  ...
  // ---- Region 6: Kiln ----
  E('kilnKnight', (r) => humanoid(r, { head: 'helmCrest', armour: 1, weapon: { kind: 'great', raised: true }, bulk: 1.3, height: 1.15, eyes: 'ember', fx: [{ kind: 'glow', cx: PW * 0.8, cy: PH * 0.3, r: 16, color: 'ember', z: 9 }] }), 'ember'),
  ...
  E('cinderLordAsh', (r) => humanoid(r, { head: 'crowned', armour: 1, weapon: { kind: 'great', raised: true }, cloak: 0.5, bulk: 1.2, height: 1.15, eyes: 'ember', fx: [{ kind: 'glow', cx: PW * 0.5, cy: PH * 0.1, r: 22, color: 'ember', z: 9 }] }), 'ember'),
  // ---- Bosses ----
  ...
  B('choirMaster', (r) => [...robed(r, { eyes: 'soul', staff: false, height: 1.08, form: 'wide', hoodForm: 'mitre', sleeves: true, fx: [] }), { kind: 'mass', pts: taper([PW * 0.7, PH * 0.55], [PW * 0.92, PH * 0.1], 8, 3, r, 0.5, 4), z: 5 }, { kind: 'mass', pts: jitter([[PW * 0.85, PH * 0.05], [PW * 0.99, PH * 0.05], [PW * 0.97, PH * 0.16], [PW * 0.87, PH * 0.16]], r, 1), z: 5, tone: 0.3 }, ...bossFx(r, 'soul')], 'soul'),
  ...
  B('keeperOfTheDeep', (r) => [...humanoid(r, { head: 'helmCrest', armour: 1, weapon: { kind: 'great', raised: false }, shield: 'round', cloak: 1, bulk: 1.5, height: 1.15, eyes: 'soul' }), ...bossFx(r, 'dark')]),
  B('namelessWanderer', (r) => humanoid(r, { head: 'hood', weapon: { kind: 'twin' }, cloak: 0.6, height: 1.1, bulk: 0.9, eyes: 'ember' })),
  B('lordOfCinders', (r) => [...humanoid(r, { head: 'crowned', armour: 1, weapon: { kind: 'great', raised: true }, cloak: 0.8, bulk: 1.5, height: 1.15, eyes: 'ember' }), ...bossFx(r, 'fire'), { kind: 'glow', cx: PW * 0.5, cy: PH * 0.05, r: 46, color: 'ember', z: 9 }], 'ember'),
  ...
  P('vesna', (r) => robed(r, { eyes: 'soul', staff: true, form: 'tall', hoodForm: 'bare', book: true }), 'soul'),
  P('corvo', (r) => humanoid(r, { head: 'hood', weapon: { kind: 'twin' }, cloak: 0.3, height: 0.95, bulk: 0.85, hunched: true, lunge: true, eyes: 'ember' })),
  P('ysolde', (r) => humanoid(r, { head: 'bare', weapon: { kind: 'rapier', raised: false }, cloak: 0.7, height: 1.08, bulk: 0.85, lunge: true, eyes: 'soul' }), 'soul'),
];
