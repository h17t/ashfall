...
:root{--void:#0A0908;--ink:#14100E;--stone:#241E1A;--ash:#4A423C;--bone:#C8BBA6;--parchment:#E8DCC4;--ember:#C8560F;--ember-hot:#F0902E;--blood:#6E1212;--blood-bright:#A81C1C;--verdigris:#3D5A4C;--wisp:#5C7A99;--gold:#B8912F}
...
async function main() {
  ...
  <div style="position:absolute;left:40px;top:40px;width:900px;height:820px">
    ...
    <div style="position:absolute;left:60px;top:40px"><div class="lab">The Cindered Approach · Boss Arena</div><div class="disp" style="font-size:46px;margin-top:6px">the Pyre-Warden</div><div class="disp" style="font-size:20px;letter-spacing:.2em;opacity:.8">Warden of the Cold Pyre</div></div>
  ...
  <div style="position:absolute;left:880px;top:90px;width:470px;height:720px;filter:drop-shadow(-18px 20px 30px rgba(0,0,0,.85))">
    ...
    <div style="position:absolute;left:44px;top:40px;right:44px">
      <div class="lab">Ember-tender · Level <span class="num" style="color:var(--bone)">31</span></div>
      ...
      <div style="display:flex;gap:10px;margin-top:26px"><div class="lab" style="border:1px solid var(--ash);padding:10px 14px;flex:1;text-align:center;color:var(--bone)">Tallowdraught <span class="num" style="color:var(--ember)">3/3</span></div><div class="lab" style="border:1px solid var(--ash);padding:10px 14px;flex:1;text-align:center;color:var(--bone)">Dodge</div></div>
      <div style="margin-top:30px;border-top:1px solid var(--ash);padding-top:18px"><div class="lab">Revenant Straight Sword <span class="num" style="color:var(--ember)">+4</span></div><div style="font-style:italic;font-size:15px;line-height:1.5;color:rgba(200,187,166,.8);margin-top:8px">The sword every revenant carries, because every revenant was once given one. Notched, honest, unremarkable. It will outlast you, and then someone else will carry it.</div><div class="num" style="margin-top:12px;font-size:16px;color:var(--bone)">Damage 214 · Strain 6 · Reprisal ×3.0 · <span style="font-family:'IM Fell English SC';letter-spacing:.1em">STR D · DEX D</span></div></div>
    </div>
  </div>`);
  ...
  <div style="position:absolute;left:80px;top:110px"><div class="disp" style="font-size:64px;letter-spacing:.24em">the Pyre-Warden</div><div style="width:260px;height:1px;background:linear-gradient(90deg,var(--ember),transparent);margin:10px 0"></div><div class="disp" style="font-size:22px;letter-spacing:.22em;opacity:.8">Warden of the Cold Pyre</div></div>
  ...
  <div style="position:absolute;left:80px;bottom:130px;display:flex;gap:40px;align-items:flex-end"><div><div class="lab">Marrow</div><div class="num" style="font-size:40px;color:var(--parchment);line-height:1">1,240,905</div></div><div><div class="lab">HP</div><div class="gauge" style="width:260px;margin-top:6px"><i style="width:100%"></i></div></div><div><div class="lab">Stamina</div><div class="gauge" style="width:200px;height:9px;margin-top:6px"><i style="width:78%;background:linear-gradient(90deg,#3D5A4C,#5f7a5a)"></i></div></div><div class="lab" style="border:1px solid var(--ash);padding:8px 14px;color:var(--bone)">Tallowdraught <span class="num" style="color:var(--ember)">3/3</span></div></div>
