  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {entries.map(([boss]) => {
        ...
        return (
          <Slab key={boss} material="parchment" seed={`soul-${boss}`} rough={7} ornament="fold" className="relative p-3 pl-[122px] min-h-[170px] flex flex-col gap-2">
            ...
            <div className="t-display text-[18px]" style={{ color: 'var(--ink)' }}>Soul of {b.name}</div>
            ...
            <p className="t-label" style={{ color: 'var(--ash)' }}>One-way. The other is lost with the soul.</p>
          </Slab>
        );
      })}
      {past.length > 0 && (
