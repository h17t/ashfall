...
npm run typecheck
npm run ci         # everything CI runs: tests, banned terms, hover, build, payload budget, PWA manifest, touch targets, accessibility, device matrix, reachability on 20 viewports, a play-through, the monkey, interruptions, the deployed shape under a sub-path
